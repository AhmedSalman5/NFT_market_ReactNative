...
const Welcome = () => {
    ...
    const moveImagesAnimation = useRef(new Animated.ValueXY({
        x: 100, y: 100
    })).current;
    ...
    return (
        ...
        // SafeAreaView  for Ios and Android  to Adjust the Screens Space
        <SafeAreaView style={styles.container}>
            ...
            <Animated.View style={[styles.textContainer, {
                ...
                <Text style={styles.subText}>
                    Explore the top collection of NFTs as well
                </Text>
            </Animated.View>
